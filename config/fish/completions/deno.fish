...
complete -c deno -n "__fish_seen_subcommand_from test" -l coverage -d 'UNSTABLE: Collect coverage profile data'
complete -c deno -n "__fish_seen_subcommand_from test" -s j -l jobs
